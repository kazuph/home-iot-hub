...
namespace hub
{
    connected_t::connected_t(const configuration& config) :
        m_config{ std::cref(config) }
    {

    }

    tl::expected<void, esp_err_t> connected_t::process_events() const noexcept
    {
    ...
    std::string_view connected_t::scan_result_to_string(ble::scanner::message_type message) noexcept
    {
